...
void main() {
  ...
  group('fetch section list', () {
    test('returns a section List if the http call completes successfully', () async {
      ...
      when(
        client.get(
          Uri.parse(Environment().config.sectionApi),
      ...
      expect(await sectionService.fetchSectionList(needMenu: false), isA<List<Section>>());
    });
  });
}