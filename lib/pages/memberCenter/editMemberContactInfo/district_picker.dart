...
class _DistrictPickerState extends State<DistrictPicker> {
  ...
  final List<Widget> _districtListWidget = [];
    ...
    for (var city in widget.cityList) {
      if (city.name == widget.member.contactAddress.city) {
        if (city.districtList != null) {
          for (var district in city.districtList!) {
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      _district ?? '行政區',
                      style: TextStyle(
                        color: _district == null ? Colors.grey : Colors.black,
                        fontSize: 17,
                      ),
                    ),
                    _isPickerActivated
  ...
  _showPicker(double height, List<City> cityList, Member member) async {
    int? cityIndex = member.contactAddress.city == null
        ? null
        : City.findCityListIndexByName(cityList, member.contactAddress.city!);

    int targetIndex = _district == null || cityIndex == null
        ? 0
        : District.findDistrictListIndexByName(
            cityList[cityIndex].districtList!, _district!);
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                          ...
                          onTap: () {
                            _district = cityList[cityIndex!]
                                .districtList![targetIndex]
                                .name;
