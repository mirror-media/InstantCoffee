...
//           height: 8,
//         ),
//         _buildStoryTitle(story.title ?? StringDefault.valueNullDefault),
//         const SizedBox(
//           height: 32,
//         ),
...
//               children: [
//                 _buildTimeTile('發布時間',
//                     story.publishedDate ?? StringDefault.valueNullDefault),
//                 const SizedBox(
//                   height: 8,
//                 ),
//                 _buildTimeTile(
//                     '更新時間', story.updatedAt ?? StringDefault.valueNullDefault),
//                 const SizedBox(
//                   height: 16,
//                 ),
//                 _buildAuthors(story),
...
//         if (isTruncated) ...[
//           _joinMemberBlock(isLogin, story.slug ?? StringDefault.valueNullDefault),
//         ],
//         if (isAdsActivated) ...[
//           const SizedBox(height: 16),
//           MMAdBanner(
...
//                 width: width, imageUrl: story.heroImage ?? StringDefault.valueNullDefault),
//           ),
