...
class PremiumUnsubscriptionCategoryList extends StatefulWidget {
  ...
  const PremiumUnsubscriptionCategoryList({
    required this.personalCategoryBloc,
  });

  @override
  _PremiumUnsubscriptionCategoryListState createState() =>
      _PremiumUnsubscriptionCategoryListState();
}

class _PremiumUnsubscriptionCategoryListState
    extends State<PremiumUnsubscriptionCategoryList> {
  @override
          ...
          return ListView(
            children: [
              Wrap(
                children: [
                  for (int index = 0;
                      index < unsubscriptionCategoryList.length;
                      index++)
                    Padding(
  ...
  Widget _buildUnSubscribedCategoryChip(
    ...
    return InkWell(
        ...
        child: Container(
          ...
          child: Padding(
            padding: const EdgeInsets.fromLTRB(8.0, 6.0, 8.0, 6.0),
            child: Text(title, style: const TextStyle(color: appColor)),
          ),
        ));
  }
}
