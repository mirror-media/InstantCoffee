...
class Story {
  ...
  factory Story.fromJson(Map<String, dynamic> json) {
    ...
    PeopleList photographersBuilder = PeopleList.fromJson(json["photographers"]);
    ...
    if (json.containsKey('heroImage') && json['heroImage'] != null && (json["heroImage"].runtimeType != 'String') && json['heroImage'].containsKey('image') && json['heroImage']['image'] != null && json['heroImage']['image'].containsKey('resizedTargets')) {
