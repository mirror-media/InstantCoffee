...
class PersonalSubscriptionService {
  ...
  Future<RecordList> fetchRecordList(int pageCount, CategoryList categoryList) async {
    String categoryListJson = json.encode(categoryList.getSubscriptionIdStringList);
    String url = apiBase + 'meta?where={"categories":{"\$in":$categoryListJson},"device":{"\$in":["all","app"]}}' + 
